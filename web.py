...
diabetes_model = pickle.load(open('/home/sri/python/diseasesPredictionProject/saved_models/diabetes_model.sav','rb'))
heart_disease_model = pickle.load(open('/home/sri/python/diseasesPredictionProject/saved_models/heart_model.sav','rb'))
parkinsons_disease_model = pickle.load(open('/home/sri/python/diseasesPredictionProject/saved_models/parkinsons_model.sav','rb'))
